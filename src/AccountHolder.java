 ...
 * for storing or updating the various attributes of an account holder including 
 * the nrc number, the first name, middle name, last name, nationality etc and a
 * single method for retrieving these attributes.
 * The various attributes are stored and retrieved based on the nrc number that
 * the user enters into a text field. Hence the retrieve method takes a 
 * column(attribute) name and nrc number as argument.
